...
def load_data_to_dim_flight_ticket_sales_table(postgres_connection):
    try:
        ...
        src_table_name                  =   'stg_flight_ticket_sales_tbl'
        table_name                      =   'dim_flight_ticket_sales_tbl'
        ...
        # Pull flight_ticket_sales_tbl data from semantic tables in Postgres database 
        try:
        ...
        create_dim_flight_ticket_sales_tbl = f'''                CREATE TABLE IF NOT EXISTS {active_schema_name}.{table_name}  (
        ...
        add_table_joins_to_table  = f'''   UPDATE {active_schema_name}.{table_name} ts
...
load_data_to_dim_flight_ticket_sales_table(postgres_connection)
