...
body_main_subject   =   "loading data from staging tables into the MDM tables of the Postgres data warehouse"
body                =   f"""Hi Stephen, 
...
semantic_layer_log_directory = get_log_filepaths(L3_LOG_DIRECTORY)

log_file_counter = 0
for log_file in semantic_layer_log_directory:
    log_file_counter += 1
    print('')
...
message["Subject"] = f"L3 - Semantic Layer Log Files - {CURRENT_TIMESTAMP}"
...
attach_log_files_to_email(message, semantic_layer_log_directory)
