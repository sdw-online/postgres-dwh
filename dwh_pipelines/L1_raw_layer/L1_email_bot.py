...
body_main_subject   =   "loading data from source systems into the raw tables of the Postgres data warehouse"
body                =   f"""Hi Stephen, 
...
raw_layer_log_directory = get_log_filepaths(L1_LOG_DIRECTORY)

log_file_counter = 0
for log_file in raw_layer_log_directory:
    log_file_counter += 1
    print('')
...
message["Subject"] = f"L1 - Raw Layer Log Files - {CURRENT_TIMESTAMP}"
...
attach_log_files_to_email(message, raw_layer_log_directory)
