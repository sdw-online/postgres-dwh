...
def test_column_data_types():
    ...
    expected_data_types = {
        ...
        'service_specialty'            :           "character varying",
...
# ====================================== TEST 10: SENIORITY LEVEL DOMAIN CONSTRAINT CHECK  ======================================

""" Check if the seniority level column only contains the "Junior", "Mid-level" and "Senior" values """

def test_seniority_level_col_values():
    valid_seniority_levels = ["Junior", "Mid-Level", "Senior"]
    sql_column = "seniority_level"
    ...
    # Assert the values in the column seniority_level column contain the values specified
    for sql_result in sql_results:
